...
//
// Frappe Cloud / on-prem benches already expose `trivena.realtime` (a socket.io
 ...
 * @param {object}  opts.realtime       - the global trivena.realtime client
 *                                        (window.trivena.realtime in prod;
 *                                        tests inject a mock)
