...
// (`api.yjs_relay`) that calls `trivena.publish_realtime` on the server side
 ...
 * @param {object} [opts.realtime]  - the socket.io client (defaults to window.trivena.realtime)
